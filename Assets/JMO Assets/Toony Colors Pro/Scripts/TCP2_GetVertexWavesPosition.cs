...
namespace ToonyColorsPro
{
    ...
    namespace Inspector
    {
        [UnityEditor.CustomEditor(typeof(ToonyColorsPro.Runtime.TCP2_GetVertexWavesPosition)), UnityEditor.CanEditMultipleObjects]
        class TCP2_GetVertexWavesPosition_Editor : UnityEditor.Editor
        {
            public override void OnInspectorGUI()
            {
                ...
                if (customSineValues.boolValue)
                {
                    ...
                    UnityEditor.EditorGUILayout.PropertyField(sinOffsets1);
                    UnityEditor.EditorGUILayout.PropertyField(phaseOffsets1);
                    UnityEditor.EditorGUILayout.PropertyField(sinOffsets2);
                    UnityEditor.EditorGUILayout.PropertyField(phaseOffsets2);
                    UnityEditor.EditorGUILayout.PropertyField(sinOffsets3);
                    UnityEditor.EditorGUILayout.PropertyField(phaseOffsets3);
                    UnityEditor.EditorGUILayout.PropertyField(sinOffsets4);
                    UnityEditor.EditorGUILayout.PropertyField(phaseOffsets4);

                    UnityEditor.EditorGUILayout.HelpBox("Change the phase and offset values if you have changed the default ones in the shader using the Shader Generator 2's Shader Properties system.", UnityEditor.MessageType.Info);
                }
